...
<svg width="512" height="512" viewBox="200 130 280 140" xmlns="http://www.w3.org/2000/svg">
  ...
  <line x1="249" y1="120" x2="249" y2="280" stroke="white" stroke-width="41" stroke-linecap="round"/>
  <line x1="431" y1="120" x2="431" y2="280" stroke="white" stroke-width="41" stroke-linecap="round"/>
  <circle cx="340" cy="200" r="80" fill="none" stroke="white" stroke-width="41"/>

  <!-- colored icon on top -->
  <g clip-path="url(#lt)">
    <line x1="249" y1="120" x2="249" y2="280" stroke="#29ABE2" stroke-width="27" stroke-linecap="round"/>
    <line x1="431" y1="120" x2="431" y2="280" stroke="#29ABE2" stroke-width="27" stroke-linecap="round"/>
    <circle cx="340" cy="200" r="80" fill="none" stroke="#29ABE2" stroke-width="27"/>
  ...
  <g clip-path="url(#lb)">
    <line x1="249" y1="120" x2="249" y2="280" stroke="#0F3D6E" stroke-width="27" stroke-linecap="round"/>
    <line x1="431" y1="120" x2="431" y2="280" stroke="#0F3D6E" stroke-width="27" stroke-linecap="round"/>
    <circle cx="340" cy="200" r="80" fill="none" stroke="#0F3D6E" stroke-width="27"/>
    <rect x="235" y="120" width="28" height="160" fill="transparent"/>
    <line x1="249" y1="120" x2="249" y2="280" stroke="#0F3D6E" stroke-width="27" stroke-linecap="round"/>
    <rect x="417" y="120" width="28" height="160" fill="transparent"/>
    <line x1="431" y1="120" x2="431" y2="280" stroke="#0F3D6E" stroke-width="27" stroke-linecap="round"/>
