...
import { MAX_WIDTH, NAV_HEIGHT } from './layout';
...
export default function PageHero({ label, title, subtitle, dark = false }) {
  ...
  return (
    <div className="db-page-hero" style={{ background: bg, padding: `${NAV_HEIGHT + 64}px 48px 72px`, borderBottom: dark ? 'none' : '0.5px solid #E2DED6' }}>
